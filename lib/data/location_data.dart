...
class LocationData {
  ...
  List<Location> get locations => [
    Location(
        ...
        description: "Site of Baxter's Close (now demolished) and the lodgings of Robert Burns on his first visit to Edinburgh during 1786-7. The ploughman poet journeyed to Edinburgh from Ayrshire to find a printer for a second edition of his Poems, Chiefly in the Scottish Dialect. William Creech became his publisher and Burns himself became a sensation in the polite circles of Edinburgh. He left a lasting impression on a young Sir Walter Scott who later wrote of him:\n‘I never saw such another eye in a human head, though I have seen the most distinguished men in my time.'",
    ...
    Location(
        ...
        description: "This museum is a fitting tribute to the writers who helped shape Edinburgh into the literary city it is today. There are collections dedicated to the life and works of Robert Burns, Sir Walter Scott and Robert Louis Stevenson. Treasures include Burns’ writing desk, Scott’s rocking horse and a pair of Stevenson’s riding boots.\n\nThe museum is in the historic Lady Stair’s House which was built in1622 and is divided into three floors. The Burns collection is in the attic, Scott occupies the middle floor and Stevenson’s belongings, including a cabinet made by the infamous criminal Deacon Brodie, are in the basement.",
    ...
    Location(
        ...
        description: "Here, Scottish writers and Makars [Poet Laureates] are celebrated with inscriptions carved into stones.\n\n'Imagine my surprise when, one cold winter's morning last year, I was phoned up out of the blue and asked if I would accept the post of Edinburgh Makar. Would I! I was gobsmacked.'\n(Ron Butlin, current Makar)\n\nThe stones feature quotations from English, Scots and Gaelic writers, including this line from Sorley MacLean:\n\n‘Nan robh againn Alba shaor, Alba co-shìnte ri ar gaol...'  \n‘If we had a Scotland free, Scotland equal to our love...’",
    ...
    Location(
        ...
        description: "This statue of the loyal dog that stayed by his master’s grave for 18 years is a must-see for lovers of Eleanor Atkinson’s popular story. His master's grave can be seen in the nearby Greyfriars Kirkyard. Bobby's monument reads:\n\n'Greyfriars Bobby\nDied 14th January 1872\nAged 16 Years\nLet his loyalty and devotion be a lesson to us all.'\n\nBobby’s statue is also the site of the Harrow Inn, the periodic residence of James Hogg, the Ettrick Shepherd (1770-1835). Hogg’s most famous work, The Private Memoirs and Confessions of a Justified Sinner, is largely set in Edinburgh with scenes on the nearby Royal Mile and Arthur’s Seat.",
    ...
    Location(
        ...
        description: "Hume, the ‘Father of the Scottish Enlightenment’, studied law at Edinburgh University from the age of 12. Hume had no interest in learning from his professors, preferring the written word:\n\n'There is nothing to be learned from a professor, which is not met with in books.'\n\nHowever Hume did not confine himself to the library, he was very sociable and often held parties because, as he believed: ‘Truth springs from argument amongst friends’.\n\nIn his work, Hume was intent on dispelling superstition and religion as no more than an aspect of human psychology. His religious beliefs, or lack of them, meant he was never given a university position. Nevertheless his philosophy went on to inspire the likes of Benjamin Franklin, Sigmund Freud and Albert Einstein. ",
    ...
    Location(
        ...
        description: "Scotland's national agency for reading and writing, an organisation committed to the promotion of reading and books. The Book Trust also leads Book Week Scotland, encouraging people of all ages and interests to celebrate Scotland’s literary scene with hundreds of events across the country. - [not open to the public]",
    ...
    Location(
        ...
        description: "Thought to be where Daniel Defoe, author of Robinson Crusoe, stayed and wrote when in Edinburgh. The character of Crusoe was inspired by a Scottish sailor, Alexander Selkirk, who was castaway on an island off the coast of Chile with no human contact until his rescue four years later.\n\n'It happen'd one day about noon going towards my boat, I was exceedingly surprised with the print of a man's naked foot on the shore.'\n(Robinson Crusoe)\n\nThe Edinburgh Courant was one of the first newspapers in Britain, a forerunner of the Edinburgh Evening News, and the Capital’s main source of local information. It is believed that Daniel Defoe was its editor, working from this house, in the early 18th century. More than this though he lodged here as a spy for the English Government in 1705-06.",
    ...
    Location(
        ...
        description: "This area has been a haunt of writers and publishers for centuries; Sir Walter Scott and James Hogg came to be published here. Later the publishers Oliver and Boyd occupied the house at the far end, once the town residence of the Earl of Tweeddale.\n\nMore recently, in 1984, the Scottish Poetry Library began its life here, led by poet Tessa Ransford, supported by a galaxy of literary talent. This included leading figures in Scotland’s literary renaissance, such as Sorley MacLean, Iain Crichton Smith, Norman MacCaig and Naomi Mitchison, all of whom read their work in this courtyard.\n\nThe Library, which was housed in what is now the Evergreen Studios, moved in 1999 to a new building in the Canongate, but publishing continues with Canongate Books and The List based in Tweeddale House.",
    ...
    Location(
        ...
        description: "This is the place for poetry in Scotland, for the regular reader, the serious student or the casual browser. There are around 30,000 items, from the oft-recited giants to the little known voices in English, Scots and Gaelic. There is also an expanding collection of European poetry, both in translation and the original language.\n\nSpecial collections include the archive of the first Scots Makar (poet laureate) Edwin Morgan and a substantial collection of work by Ian Hamilton Finlay. The library specialises in concrete poetry, small press and artists’ books. There are events, workshops and courses throughout the year.",
