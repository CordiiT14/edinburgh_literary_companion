...
class LocationData {
  ...
  List<Location> get locations => [
    ...
    Location(
        ...
        description: "Built to house a life size statue of  Burns in white marble by John Flaxman (has been on loan to Scottish National Portrait Gallery since 1861). Commemorates Scotland's iconic poet & lyricist, Robert Burns.",
    ...
    Location(
        name: "Arthur Conan Doyle Statue",
        category: Category.Landmark,
    ...
    Location(
        ...
        description: "Former railway tunnel by the Water of Leith that was recently revived and painted with a full length street art mural to the lines of Robert Louis Stevenson's poem, 'From a Railway Carriage'.",
